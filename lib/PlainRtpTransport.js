...
const logger = new Logger('LPZ mediasoup PlainRtpTransport');
...
class PlainRtpTransport extends Transport
{
	...
	{
		logger.debug('connect() | [ip:%o, port:%o, rtcpPort:%o]', ip, port, rtcpPort);
	...
	{
		logger.debug('consume() | [params:%o]', params);
