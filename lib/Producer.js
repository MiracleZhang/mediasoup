...
const logger = new Logger('LPZ mediasoup Producer');
...
class Producer extends EnhancedEventEmitter
{
	...
	constructor({ internal, data, channel, appData, paused })
	{
		...
		logger.debug('constructor() | [internal:%o, data:%o, channel:%o, appData:%o, paused:%o]',
			internal, data, channel, appData, paused);
