...
const logger = new Logger('LPZ mediasoup Index');
...
{
	logger.debug('createWorker() | [logLevel:%o, logTags:%o, rtcMinPort:%o, rtcMaxPort:%o, dtlsCertificateFile:%o, dtlsPrivateKeyFile:%o]',
...
{
	logger.debug('getSupportedRtpCapabilities | [supportedRtpCapabilities:%o]', supportedRtpCapabilities)
