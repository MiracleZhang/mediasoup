...
const logger = new Logger('LPZ mediasoup PipeTransport');
...
class PipeTransport extends Transport
{
	...
	constructor({ data, ...params })
	{
		...
		logger.debug('constructor() | [data:%o, params:%o]', data, params);
	...
	{
		logger.debug('connect() | [ip:%o, port:%o]', ip, port);
   ...
   * @override
	...
	{
		logger.debug('consume() | [producerId:%o, appData:%o]', producerId, appData);
		...
		logger.debug('consume() | new Consumer, [consumer:%o]', consumer);
