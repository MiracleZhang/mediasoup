...
const logger = new Logger('LPZ mediasoup WebRtcTransport');
...
class WebRtcTransport extends Transport
{
	...
	{
		logger.debug('connect() | [dtlsParameters:%o]', dtlsParameters);
	...
	_handleWorkerNotifications()
	{
		...
		{
			logger.debug('_handleWorkerNotifications() | [event:%o, data:%o]', event, data);
			switch (event)
			{
				case 'icestatechange':
				{
