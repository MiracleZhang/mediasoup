...
class Channel extends EnhancedEventEmitter
{
	...
	{
		const logger = new Logger(`LPZ mediasoup Channel[pid:${pid}]`);
		const workerLogger = new Logger(`LPZ mediasoup worker[pid:${pid}]`);
		...
		this._logger.debug('constructor() | [pid:%o]', pid);
