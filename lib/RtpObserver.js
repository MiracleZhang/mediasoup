...
const logger = new Logger('LPZ mediasoup RtpObserver');
...
class RtpObserver extends EnhancedEventEmitter
{
	...
	constructor({ internal, channel, getProducerById })
	{
		...
		logger.debug('constructor() | [internal:%o, channel:%o, getProducerById:%o]', internal, channel, getProducerById);
	...
	{
		logger.debug('addProducer() | [producerId:%o]', producerId);
	...
	{
		logger.debug('removeProducer() | [producerId:%o]', producerId);
